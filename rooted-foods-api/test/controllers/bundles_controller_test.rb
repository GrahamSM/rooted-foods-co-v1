...
class BundlesControllerTest < ActionController::TestCase
  ...
  test "should create bundle" do
    assert_difference('Bundle.count') do
      post :create, bundle: { description: @bundle.description, image: @bundle.image, price: @bundle.price }
    end
  ...
  test "should update bundle" do
    patch :update, id: @bundle, bundle: { description: @bundle.description, image: @bundle.image, price: @bundle.price }
    assert_redirected_to bundle_path(assigns(:bundle))
  end
